...
class LaunchesRvAdapter(var launches: List<RocketLaunch>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LaunchViewHolder {
        return LayoutInflater.from(parent.context).inflate(R.layout.item_launch, parent, false)
    ...
    inner class LaunchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindData(launch: RocketLaunch) {
            ...
            if (launchSuccess != null) {
                if (launchSuccess) {
                    ...
                    launchSuccessTextView.setTextColor(
                        (ContextCompat.getColor(
                            itemView.context, R.color.colorSuccessful
                        ))
                    )
                } else {
                    ...
                    launchSuccessTextView.setTextColor(
                        (ContextCompat.getColor(
                            itemView.context, R.color.colorUnsuccessful
                        ))
                    )
                }
            } else {
                ...
                launchSuccessTextView.setTextColor(
                    (ContextCompat.getColor(
                        itemView.context, R.color.colorNoData
                    ))
                )
            }
        }
